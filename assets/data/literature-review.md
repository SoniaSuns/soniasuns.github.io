...
更新：2026-09-16。158份按PDF内容去重的笔记；结果依据本地版本，未重跑实验。
...
- **时间**：2026；作者仓库于2026-08-23宣布TPAMI录用。本地PDF为2026年IEEE已接收作者稿，页眉注明尚未完成最终编辑；本地下载日期为2026-09-16。
- **发表平台／版本状态**：IEEE Transactions on Pattern Analysis and Machine Intelligence（TPAMI），2026，已接收作者版本；DOI: 10.1109/TPAMI.2026.3729756。当前PDF不能当作已完成最终编辑的卷期排版版。
- **论文链接**：[IEEE DOI（本地版本）](https://doi.org/10.1109/TPAMI.2026.3729756)；[作者发表列表](https://sierkinhane.github.io/)；[相关早期预印本（旧题名）](https://arxiv.org/abs/2404.15909v1)
