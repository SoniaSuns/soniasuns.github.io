...
- [P161 · Learning Long-form Movie Prior via Large Language Models](#p161)
- [P162 · Timestep Embedding Tells: It's Time to Cache for Video Diffusion Model](#p162)
- [P163 · Automating the Search for Artificial Life with Foundation Models](#p163)
- [P164 · Diffusion as Shader: 3D-aware Video Diffusion for Versatile Video Generation Control](#p164)
...
- **时间与版本**：本地版本：2019-03-11（arXiv:1810.02890v2）；正式发表时间如已核实，见下一项。
- **发表平台**：ICRA 2019（正式发表）；初稿 2018；本地 arXiv v2：2019-03-11。 [作者机构记录](https://experts.illinois.edu/en/publications/hg-dagger-interactive-imitation-learning-with-human-experts/)
- **论文与正式记录**：[arXiv本地版本 1810.02890v2](https://arxiv.org/abs/1810.02890v2)
...
- **时间与版本**：本地版本：2020-02-14（arXiv:1908.05739v2）；正式发表时间如已核实，见下一项。
- **发表平台**：ICLR 2020（PDF 明示）；本地 arXiv v2：2020-02-14
- **论文与正式记录**：[arXiv本地版本 1908.05739v2](https://arxiv.org/abs/1908.05739v2)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **时间与版本**：本地版本：2022-06-01（arXiv:2112.09332v3）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv 技术报告；初稿 2021；本地 v3：2022-06-01；PDF 未标正式会议/期刊
- **论文与正式记录**：[arXiv本地版本 2112.09332v3](https://arxiv.org/abs/2112.09332v3)
...
- **时间与版本**：2022年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：ACL 2022，Long Papers，1138–1149；会议 2022-05-22 至 05-27
...
- **时间与版本**：本地版本：2022-06-30（arXiv:2206.15448v1）；正式发表时间如已核实，见下一项。
- **发表平台**：ICML 2022（PDF 元数据与正文）；本地 arXiv v1：2022-06-30
- **论文与正式记录**：[arXiv本地版本 2206.15448v1](https://arxiv.org/abs/2206.15448v1)
...
- **时间与版本**：2022年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：ECCV 2022（官方记录核验）。 [ECVA官方论文页](https://www.ecva.net/papers/eccv_2022/papers_ECCV/html/5263_ECCV_2022_paper.php)
...
- **时间与版本**：本地版本：2022-03-26（arXiv:2203.14040v1）；正式发表时间如已核实，见下一项。
- **发表平台**：CVPR 2022，pp.15565–15575（官方CVF记录核验）。 [CVF官方论文页](https://openaccess.thecvf.com/content/CVPR2022/html/Liang_Visual_Abductive_Reasoning_CVPR_2022_paper.html)
- **论文与正式记录**：[arXiv本地版本 2203.14040v1](https://arxiv.org/abs/2203.14040v1)
...
- **时间与版本**：本地版本：2023-08-12（arXiv:2303.07274v4）；正式发表时间如已核实，见下一项。
- **发表平台**：ICCV 2023，2616–2627；本地 arXiv v4：2023-08-12。 [CVF官方论文页](https://openaccess.thecvf.com/content/ICCV2023/html/Bitton-Guetta_Breaking_Common_Sense_WHOOPS_A_Vision-and-Language_Benchmark_of_Synthetic_and_ICCV_2023_paper.html)
- **论文与正式记录**：[arXiv本地版本 2303.07274v4](https://arxiv.org/abs/2303.07274v4)
...
- **时间与版本**：本地版本：2023-01-20（arXiv:2301.08571v1）；正式发表时间如已核实，见下一项。
- **发表平台**：TACL 2023，11:565–581；本地为 2023-01-20 预出版稿。 [ACL Anthology记录](https://aclanthology.org/2023.tacl-1.33/)
- **论文与正式记录**：[arXiv本地版本 2301.08571v1](https://arxiv.org/abs/2301.08571v1)
...
- **时间与版本**：本地版本：2024-03-28（arXiv:2307.02477v3）；正式发表时间如已核实，见下一项。
- **发表平台**：NAACL 2024，Long Papers，pp.1819–1862（官方ACL记录核验）；本地arXiv v3：2024-03-28。 [ACL Anthology记录](https://aclanthology.org/2024.naacl-long.102/)
- **论文与正式记录**：[arXiv本地版本 2307.02477v3](https://arxiv.org/abs/2307.02477v3)
...
- **时间与版本**：2023年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：NeurIPS 2023（会议论文）
...
- **时间与版本**：本地版本：2023-12-01（arXiv:2312.00785v1）；正式发表时间如已核实，见下一项。
- **发表平台**：CVPR 2024，pp.22861–22872（官方CVF记录核验）；本地为2023-12-01预印版。 [CVF官方论文页](https://openaccess.thecvf.com/content/CVPR2024/html/Bai_Sequential_Modeling_Enables_Scalable_Learning_for_Large_Vision_Models_CVPR_2024_paper.html)
- **论文与正式记录**：[arXiv本地版本 2312.00785v1](https://arxiv.org/abs/2312.00785v1)
...
- **时间与版本**：本地版本：2023-10-19（arXiv:2305.16291v2）；正式发表时间如已核实，见下一项。
- **发表平台**：本地 arXiv v2：2023-10-19；正式平台待核验
- **论文与正式记录**：[arXiv本地版本 2305.16291v2](https://arxiv.org/abs/2305.16291v2)
...
- **时间与版本**：本地版本：2024-08-07（arXiv:2408.00114v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2408.00114v2（本地版本）；正式会议/期刊未核实
- **论文与正式记录**：[arXiv本地版本 2408.00114v2](https://arxiv.org/abs/2408.00114v2)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：本地版本：2024-08-15（arXiv:2408.08021v1）；正式发表时间如已核实，见下一项。
- **发表平台**：EMNLP 2023，pp.9677–9695（官方ACL记录核验）；本地arXiv上传时间2024-08-15晚于会议。 [ACL Anthology记录](https://aclanthology.org/2023.emnlp-main.601/)
- **论文与正式记录**：[arXiv本地版本 2408.08021v1](https://arxiv.org/abs/2408.08021v1)
...
- **时间与版本**：本地版本：2024-06-27（arXiv:2401.03183v2）；正式发表时间如已核实，见下一项。
- **发表平台**：Findings of ACL 2024，pp.6433–6452（官方记录核验）。 [ACL Anthology记录](https://aclanthology.org/2024.findings-acl.384/)
- **论文与正式记录**：[arXiv本地版本 2401.03183v2](https://arxiv.org/abs/2401.03183v2)
...
- **时间与版本**：本地版本：2024-06-17（arXiv:2406.11179v1）；正式发表时间如已核实，见下一项。
- **发表平台**：ICML 2024（PDF 明示）
- **论文与正式记录**：[arXiv本地版本 2406.11179v1](https://arxiv.org/abs/2406.11179v1)
...
- **时间与版本**：本地版本：2024-10-03（arXiv:2410.02613v1）；正式发表时间如已核实，见下一项。
- **发表平台**：本地稿标注 Under review；arXiv v1：2024-10-03；不据此认定已被某会议接收
- **论文与正式记录**：[arXiv本地版本 2410.02613v1](https://arxiv.org/abs/2410.02613v1)
...
- **时间与版本**：本地版本：2024-05-17（arXiv:2310.05872v2）；正式发表时间如已核实，见下一项。
- **发表平台**：Findings of ACL 2024，pp.10783–10795（官方记录核验）；本地末位作者名Xin Eric Wang，ACL记录简写Xin Wang。 [ACL Anthology记录](https://aclanthology.org/2024.findings-acl.640/)
- **论文与正式记录**：[arXiv本地版本 2310.05872v2](https://arxiv.org/abs/2310.05872v2)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、XR与人机协作
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：CVPR 2025（PDF 元数据及官方记录）
...
- **时间与版本**：本地版本：2025-10-10（arXiv:2507.17131v2）；正式发表时间如已核实，见下一项。
- **发表平台**：EMNLP 2025 Industry Track，pp.1625–1653（官方记录核验）；正文结果按本地arXiv v2。 [ACL Anthology记录](https://aclanthology.org/2025.emnlp-industry.115/)
- **论文与正式记录**：[arXiv本地版本 2507.17131v2](https://arxiv.org/abs/2507.17131v2)
...
- **时间与版本**：本地版本：2025-10-23（arXiv:2510.20607v1）；正式发表时间如已核实，见下一项。
- **发表平台**：NeurIPS 2025 Main Conference Track（官方论文集核验）。 [NeurIPS官方论文集](https://proceedings.neurips.cc/paper_files/paper/2025/hash/7b22ed7325629fd4c041d47139410fd9-Abstract-Conference.html)
- **论文与正式记录**：[arXiv本地版本 2510.20607v1](https://arxiv.org/abs/2510.20607v1)
...
- **时间与版本**：本地版本：2025-12-31（arXiv:2512.24695v1）；正式发表时间如已核实，见下一项。
- **发表平台**：NeurIPS 2025 Main Conference Track（官方论文集核验）；正式题名末词Architectures为复数，本地首页Architecture为单数。 [NeurIPS官方论文集](https://proceedings.neurips.cc/paper_files/paper/2025/hash/4309616aaed8e848009bc4a7ef73b493-Abstract-Conference.html)
- **论文与正式记录**：[arXiv本地版本 2512.24695v1](https://arxiv.org/abs/2512.24695v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、XR与人机协作
...
- **时间与版本**：本地版本：2025-10-16（arXiv:2510.14901v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2510.14901v1（本地版本）；正式会议/期刊未核实
- **论文与正式记录**：[arXiv本地版本 2510.14901v1](https://arxiv.org/abs/2510.14901v1)
...
- **时间与版本**：本地版本：2025-06-05（arXiv:2402.17213v2）；正式发表时间如已核实，见下一项。
- **发表平台**：Findings of ACL 2025（官方记录核验）；本地arXiv:2402.17213v2。 [ACL Anthology记录](https://aclanthology.org/2025.findings-acl.290/)
- **论文与正式记录**：[arXiv本地版本 2402.17213v2](https://arxiv.org/abs/2402.17213v2)
...
- **时间与版本**：本地版本：2025-09-29（arXiv:2509.20328v2）；正式发表时间如已核实，见下一项。
- **发表平台**：Google DeepMind研究预印稿；首页2025-10-01；arXiv:2509.20328v2时间2025-09-29
- **论文与正式记录**：[arXiv本地版本 2509.20328v2](https://arxiv.org/abs/2509.20328v2)
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：CHI 2025，2025-04-26 至 05-01；DOI 10.1145/3706598.3713417
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3706598.3713417)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全
...
- **时间与版本**：本地版本：2026-01-06（arXiv:2601.02771v1）；正式发表时间如已核实，见下一项。
- **发表平台**：AAAI 2026，40(4):2698–2706；正式上线2026-03-14，DOI 10.1609/aaai.v40i4.37258（AAAI官方核验）；本地为arXiv v1。 [AAAI官方论文页](https://ojs.aaai.org/index.php/AAAI/article/view/37258)
- **论文与正式记录**：[arXiv本地版本 2601.02771v1](https://arxiv.org/abs/2601.02771v1)；[DOI正式记录](https://doi.org/10.1609/aaai.v40i4.37258)
...
- **时间与版本**：本地版本：2026-01-18（arXiv:2601.12538v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2601.12538v1，2026-01-18（本地综述稿）
- **论文与正式记录**：[arXiv本地版本 2601.12538v1](https://arxiv.org/abs/2601.12538v1)
...
- **时间与版本**：本地版本：2026-05-06（arXiv:2602.01187v2）；正式发表时间如已核实，见下一项。
- **发表平台**：Preprint；稿面2026-05-07；arXiv:2602.01187v2时间2026-05-06
- **论文与正式记录**：[arXiv本地版本 2602.01187v2](https://arxiv.org/abs/2602.01187v2)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全
...
- **时间与版本**：本地版本：2026-05-02（arXiv:2603.28767v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2603.28767v2，2026-05-02（本地技术报告）
- **论文与正式记录**：[arXiv本地版本 2603.28767v2](https://arxiv.org/abs/2603.28767v2)
...
- **时间与版本**：本地版本：2026-01-30（arXiv:2505.08140v5）；正式发表时间如已核实，见下一项。
- **发表平台**：NeurIPS 2025（PDF首页会议页脚）；本地arXiv:2505.08140v5更新2026-01-30
- **论文与正式记录**：[arXiv本地版本 2505.08140v5](https://arxiv.org/abs/2505.08140v5)
...
- **时间与版本**：本地版本：2026-02-02（arXiv:2602.01756v1）；正式发表时间如已核实，见下一项。
- **发表平台**：Preprint；稿面2026-02-03；arXiv:2602.01756v1时间2026-02-02
- **论文与正式记录**：[arXiv本地版本 2602.01756v1](https://arxiv.org/abs/2602.01756v1)
...
- **时间与版本**：2026年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：CHI 2026，2026-04-13 至 04-17；DOI 10.1145/3772318.3791514
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3772318.3791514)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全、世界机制与演化
...
- **时间与版本**：2026年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：ICLR 2026（PDF 明示 Published as a conference paper）
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、AI方法与评测
...
- **时间与版本**：2024年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：FAccT 2024，2024-06-03 至 06-06；DOI 10.1145/3630106.3658941
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3630106.3658941)
...
- **时间与版本**：本地版本：2026-01-26（arXiv:2601.18428v1）；正式发表时间如已核实，见下一项。
- **发表平台**：CHI 2026，2026-04-13 至 04-17（作者版明示正式记录）；DOI 10.1145/3772318.3791160
- **论文与正式记录**：[arXiv本地版本 2601.18428v1](https://arxiv.org/abs/2601.18428v1)；[DOI正式记录](https://doi.org/10.1145/3772318.3791160)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全
...
- **时间与版本**：本地版本：2020-05-01（arXiv:2005.00582v1）；正式发表时间如已核实，见下一项。
- **发表平台**：IJCAI 2020，pp.1526–1533（官方论文集核验）。 [IJCAI官方论文页](https://www.ijcai.org/proceedings/2020/212)
- **论文与正式记录**：[arXiv本地版本 2005.00582v1](https://arxiv.org/abs/2005.00582v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：XR与人机协作
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：2025 年研究稿；ICML 2025 模板元数据；arXiv:2506.15732，主会/Workshop 身份不能只由模板判断。 [arXiv记录](https://arxiv.org/abs/2506.15732)
- **论文与正式记录**：[arXiv论文记录](https://arxiv.org/abs/2506.15732)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：本地版本：2025-04-30（arXiv:2406.01933v2）；正式发表时间如已核实，见下一项。
- **发表平台**：COLT 2025 Extended Abstract，PMLR291:5712–5713（官方记录核验）；本地为完整研究稿，首页2025-05-02、arXiv v2为2025-04-30，两者篇幅不可混淆。 [PMLR官方记录](https://proceedings.mlr.press/v291/whitehouse25a.html)
- **论文与正式记录**：[arXiv本地版本 2406.01933v2](https://arxiv.org/abs/2406.01933v2)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **作者**：Khurram Yamin; Shantanu Gupta; Gaurav Ghosal; Zachary Lipton; Bryan Wilder
- **时间与版本**：本地版本：2025-06-15（arXiv:2410.23884v5）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2410.23884v5，2025-06-15；后续改题的ICLR 2026版本见P042
- **论文与正式记录**：[arXiv本地版本 2410.23884v5](https://arxiv.org/abs/2410.23884v5)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **时间与版本**：本地版本：2025-05-27（arXiv:2505.20634v1）；正式发表时间如已核实，见下一项。
- **发表平台**：Preprint, Under review；arXiv:2505.20634v1，2025-05-27（本地版本）
- **论文与正式记录**：[arXiv本地版本 2505.20634v1](https://arxiv.org/abs/2505.20634v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：NeurIPS 2025 Workshop（CISPA 记录日期 2025-12-06）；本地为匿名稿。 [CISPA机构记录](https://cispa.de/en/research/publications/104502-can-llms-propose-instrumental-variables-for-causal-reasoning-)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：NeurIPS 2025，Position Paper Track；本地文件制作时间 2026 不应改为发表年
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、XR与人机协作
...
- **时间与版本**：预印首发2024-12-14；本地摘要对应2025-06-02 arXiv v3；正式Science论文2026-04-30上线
- **发表平台**：Science 392(6797):524–527，2026-04-30，DOI 10.1126/science.adz4433；正式题名为Performance of a large language model on the reasoning tasks of a physician（删除Superhuman）。本条英文摘要与结果仍按本地预印稿。 [PubMed正式发表记录](https://pubmed.ncbi.nlm.nih.gov/42060751/)；[arXiv记录](https://arxiv.org/abs/2412.10849)
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1126/science.adz4433)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **时间与版本**：2019年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：AAAI 2019（首页明示 AAAI-19），1658 起
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **作者**：Eric Horvitz
- **时间与版本**：1999年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：CHI 1999，1999-05-15—20，pp.159–166（PDF首页）
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全、XR与人机协作
...
- **时间与版本**：本地PDF未明确；未按文件名或PDF制作时间推断。
- **发表平台**：2026年预印本；首页标注arXiv，ACM DOI/ISBN为占位符，不能据此认定正式ACM发表
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：UIST 2025，2025-09-28—10-01；DOI 10.1145/3746059.3747621
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3746059.3747621)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：XR与人机协作
...
- **时间与版本**：2026年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：CHI 2026，2026-04-13—17；DOI 10.1145/3772318.3790520
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3772318.3790520)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全、XR与人机协作
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：UIST 2025；DOI 10.1145/3746059.3747748
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3746059.3747748)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：XR与人机协作
...
- **时间与版本**：本地版本：2025-09-29（arXiv:2509.25504v1）；正式发表时间如已核实，见下一项。
- **发表平台**：Preliminary White Paper，2025-09；arXiv:2509.25504v1
- **论文与正式记录**：[arXiv本地版本 2509.25504v1](https://arxiv.org/abs/2509.25504v1)
...
- **时间与版本**：2026年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：CHI 2026；DOI 10.1145/3772318.3790938
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3772318.3790938)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：XR与人机协作
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：CHI 2025，2025-04-26—05-01；DOI 10.1145/3706598.3713905
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3706598.3713905)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全、XR与人机协作
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：Findings of ACL: NAACL 2025，2025-04-29—05-04，pp.7683–7699
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：本地版本：2025-03-16（arXiv:2503.12447v1）；正式发表时间如已核实，见下一项。
- **发表平台**：National University of Singapore博士学位论文，封面2023；arXiv:2503.12447v1，2025-03-16上传；各章对应ACM MM/CVPR/ICCV等独立论文
- **论文与正式记录**：[arXiv本地版本 2503.12447v1](https://arxiv.org/abs/2503.12447v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **时间与版本**：本地版本：2023-06-23（arXiv:2306.07932v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2306.07932，首发2023-06-10；本地稿未标明正式会议。 [arXiv记录](https://arxiv.org/abs/2306.07932)
- **论文与正式记录**：[arXiv本地版本 2306.07932v2](https://arxiv.org/abs/2306.07932v2)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **时间与版本**：预印稿2023年；正式发表于ICLR 2024，本地版本具体修订日未明示
- **发表平台**：ICLR 2024（官方论文集核验）；本地为2023年较早预印稿。 [ICLR官方记录](https://proceedings.iclr.cc/paper_files/paper/2024/file/aca97732e30bcf1303bc22ac3924fd16-Paper-Conference.pdf)
...
- **时间与版本**：本地版本：2024-06-17（arXiv:2406.12045v1）；正式发表时间如已核实，见下一项。
- **发表平台**：2024年arXiv预印本（本地版本）
- **论文与正式记录**：[arXiv本地版本 2406.12045v1](https://arxiv.org/abs/2406.12045v1)
...
- **时间与版本**：本地版本：2025-03-12（arXiv:2503.09566v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2503.09566v1，2025-03（本地预印本）
- **论文与正式记录**：[arXiv本地版本 2503.09566v1](https://arxiv.org/abs/2503.09566v1)
...
- **时间与版本**：本地版本：2026-02-21（arXiv:2503.13444v3）；正式发表时间如已核实，见下一项。
- **发表平台**：ICLR 2026（PDF页眉）；arXiv:2503.13444v3
- **论文与正式记录**：[arXiv本地版本 2503.13444v3](https://arxiv.org/abs/2503.13444v3)
...
- **时间与版本**：本地版本：2025-03-18（arXiv:2503.14378v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2503.14378v1，2025-03（本地版本）
- **论文与正式记录**：[arXiv本地版本 2503.14378v1](https://arxiv.org/abs/2503.14378v1)
...
- **时间与版本**：本地版本：2025-11-21（arXiv:2511.17481v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2511.17481v1，2025-11（本地版本）；保留文件名中的CVPR未获本次充分核验，不作为正式发表记录。
- **论文与正式记录**：[arXiv本地版本 2511.17481v1](https://arxiv.org/abs/2511.17481v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：本地版本：2025-12-09（arXiv:2512.08765v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2512.08765v1，2025-12（本地版本）
- **论文与正式记录**：[arXiv本地版本 2512.08765v1](https://arxiv.org/abs/2512.08765v1)
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：本地30页早期稿；2025-06发布，Apple官方项目页另标NeurIPS；后续版本不与本地结果混合。 [Apple研究页面](https://machinelearning.apple.com/research/illusion-of-thinking)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、AI方法与评测
...
- **时间与版本**：本地版本：2025-03-28（arXiv:2503.22115v1）；正式发表时间如已核实，见下一项。
- **发表平台**：Preprint, Under review；arXiv:2503.22115，2025-03-28。 [arXiv记录](https://arxiv.org/abs/2503.22115)
- **论文与正式记录**：[arXiv本地版本 2503.22115v1](https://arxiv.org/abs/2503.22115v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：本地版本：2025-12-25（arXiv:2504.13460v5）；正式发表时间如已核实，见下一项。
- **发表平台**：IEEE Transactions on Image Processing（PDF页眉）；arXiv:2504.13460v5，具体卷期/正式出版日未在本地明确
- **论文与正式记录**：[arXiv本地版本 2504.13460v5](https://arxiv.org/abs/2504.13460v5)
...
- **时间与版本**：本地版本：2025-06-30（arXiv:2506.23678v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2506.23678v1，2025-06-30（本地版本）
- **论文与正式记录**：[arXiv本地版本 2506.23678v1](https://arxiv.org/abs/2506.23678v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全、XR与人机协作
...
- **时间与版本**：本地版本：2026-05-08（arXiv:2508.01191v6）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2508.01191v6（本地版本）
- **论文与正式记录**：[arXiv本地版本 2508.01191v6](https://arxiv.org/abs/2508.01191v6)
...
- **时间与版本**：本地版本：2025-10-20（arXiv:2510.17771v1）；正式发表时间如已核实，见下一项。
- **发表平台**：Preprint, Under Review；arXiv:2510.17771v1
- **论文与正式记录**：[arXiv本地版本 2510.17771v1](https://arxiv.org/abs/2510.17771v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、XR与人机协作
...
- **时间与版本**：本地版本：2025-11-26（arXiv:2511.20351v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2511.20351v2（本地版本）
- **论文与正式记录**：[arXiv本地版本 2511.20351v2](https://arxiv.org/abs/2511.20351v2)
...
- **时间与版本**：本地版本：2025-12-29（arXiv:2509.01412v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2509.01412v2（本地预印本）
- **论文与正式记录**：[arXiv本地版本 2509.01412v2](https://arxiv.org/abs/2509.01412v2)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全、世界机制与演化、XR与人机协作
...
- **时间与版本**：本地版本：2026-05-26（arXiv:2602.10104v2）；正式发表时间如已核实，见下一项。
- **发表平台**：ICML 2026，PMLR306（PDF首页）；arXiv:2602.10104v2
- **论文与正式记录**：[arXiv本地版本 2602.10104v2](https://arxiv.org/abs/2602.10104v2)
...
- **时间与版本**：本地版本：2026-05-28（arXiv:2602.11389v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2602.11389v2（本地版本）
- **论文与正式记录**：[arXiv本地版本 2602.11389v2](https://arxiv.org/abs/2602.11389v2)
...
- **时间与版本**：本地版本：2026-05-22（arXiv:2605.23699v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2605.23699v1，2026-05（本地版本）
- **论文与正式记录**：[arXiv本地版本 2605.23699v1](https://arxiv.org/abs/2605.23699v1)
...
- **时间与版本**：本地版本：2026-09-02（arXiv:2609.02886v1）；正式发表时间如已核实，见下一项。
- **发表平台**：2026-09技术报告；arXiv:2609.02886v1
- **论文与正式记录**：[arXiv本地版本 2609.02886v1](https://arxiv.org/abs/2609.02886v1)
...
- **时间与版本**：本地版本：2026-03-07（arXiv:2602.21497v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2602.21497v2（本地版本）
- **论文与正式记录**：[arXiv本地版本 2602.21497v2](https://arxiv.org/abs/2602.21497v2)
...
- **时间与版本**：本地版本：2026-04-05（arXiv:2604.04207v1）；正式发表时间如已核实，见下一项。
- **发表平台**：Preprint, Under Review；arXiv:2604.04207v1
- **论文与正式记录**：[arXiv本地版本 2604.04207v1](https://arxiv.org/abs/2604.04207v1)
...
- **时间与版本**：本地版本：2026-02-25（arXiv:2602.06034v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2602.06034v2（本地版本）
- **论文与正式记录**：[arXiv本地版本 2602.06034v2](https://arxiv.org/abs/2602.06034v2)
...
- **时间与版本**：本地版本：2026-05-25（arXiv:2605.12374v4）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2605.12374v4（本地版本）
- **论文与正式记录**：[arXiv本地版本 2605.12374v4](https://arxiv.org/abs/2605.12374v4)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **时间与版本**：本地匿名稿未注明日期；ICLR 2026是投稿轮次，不作为正式发表时间
- **发表平台**：Under review as a conference paper at ICLR 2026；此状态不表示已录用，日期未明确
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全、世界机制与演化、XR与人机协作
...
- **时间与版本**：2026年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：IUI 2026，2026-03-23—26；DOI 10.1145/3742413.3789134
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3742413.3789134)
...
- **时间与版本**：本地版本：2026-03-14（arXiv:2603.14117v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2603.14117v1，2026-03（本地版本）
- **论文与正式记录**：[arXiv本地版本 2603.14117v1](https://arxiv.org/abs/2603.14117v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、XR与人机协作
...
- **时间与版本**：本地版本：2026-05-08（arXiv:2604.25809v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2604.25809v2（本地版本）
- **论文与正式记录**：[arXiv本地版本 2604.25809v2](https://arxiv.org/abs/2604.25809v2)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、XR与人机协作
...
- **时间与版本**：本地版本：2026-05-24（arXiv:2605.15777v2）；正式发表时间如已核实，见下一项。
- **发表平台**：技术报告，首页2026-05-26；arXiv:2605.15777v2
- **论文与正式记录**：[arXiv本地版本 2605.15777v2](https://arxiv.org/abs/2605.15777v2)
...
- **时间与版本**：本地版本：2026-01-07（arXiv:2601.06176v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2601.06176v1，2026-01（本地版本）
- **论文与正式记录**：[arXiv本地版本 2601.06176v1](https://arxiv.org/abs/2601.06176v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：XR与人机协作
...
- **时间与版本**：本地版本：2026-05-07（arXiv:2601.18744v2）；正式发表时间如已核实，见下一项。
- **发表平台**：ICML 2026，PMLR306（PDF首页）；arXiv:2601.18744v2
- **论文与正式记录**：[arXiv本地版本 2601.18744v2](https://arxiv.org/abs/2601.18744v2)
...
- **时间与版本**：本地版本：2026-05-13（arXiv:2605.12978v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2605.12978v1，2026-05（本地版本）
- **论文与正式记录**：[arXiv本地版本 2605.12978v1](https://arxiv.org/abs/2605.12978v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **时间与版本**：本地版本：2026-04-01（arXiv:2604.00455v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2604.00455v1，2026-04（本地版本）
- **论文与正式记录**：[arXiv本地版本 2604.00455v1](https://arxiv.org/abs/2604.00455v1)
...
- **时间与版本**：本地版本：2026-03-19（arXiv:2603.20314v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2603.20314v1，2026-03（本地预印本）；模板不能证明已正式录用
- **论文与正式记录**：[arXiv本地版本 2603.20314v1](https://arxiv.org/abs/2603.20314v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、XR与人机协作
...
- **时间与版本**：首发2025-10-07；本地PDF具体版本时间未明示
- **发表平台**：arXiv:2510.06077，首发2025-10-07（官方arXiv核验）；本地版本日期未从首页确定，文件名26不是发表证据。 [arXiv记录](https://arxiv.org/abs/2510.06077)
- **论文与正式记录**：[arXiv论文记录](https://arxiv.org/abs/2510.06077)
...
- **时间与版本**：2022年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：IEEE Access，Vol.10，2022；收到2022-07-18、接受09-01、发表09-08、当前版09-30；DOI 10.1109/ACCESS.2022.3205314
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1109/ACCESS.2022.3205314)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全、世界机制与演化
...
- **时间与版本**：本地版本：2025-11-03（arXiv:2412.06769v3）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2412.06769v3（本地署名版）；正式平台另待核验
- **论文与正式记录**：[arXiv本地版本 2412.06769v3](https://arxiv.org/abs/2412.06769v3)
- **项目 · 代码 · 数据**：[代码：facebookresearch/coconut](https://github.com/facebookresearch/coconut)
- **版本关系**：同一论文只保留本地较新的2025-11-03 arXiv v3署名稿。P026的15页早期匿名稿已归档；P109为完全相同副本的历史别名。旧条目链接跳转到本条，旧个人笔记保留并合并。
- **主题**：世界机制与演化、AI方法与评测
...
- **时间与版本**：2023年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：EMNLP 2023，2023-12-06—10，pp.8154–8173
...
- **时间与版本**：本地版本：2024-08-11（arXiv:2404.05221v2）；正式发表时间如已核实，见下一项。
- **发表平台**：COLM 2024（PDF首页）
- **论文与正式记录**：[arXiv本地版本 2404.05221v2](https://arxiv.org/abs/2404.05221v2)
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：Findings of ACL 2025，2025-07-27—08-01，pp.8881–8893
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、XR与人机协作、AI方法与评测
...
- **时间与版本**：本地匿名稿未注明日期；ICLR 2025是投稿轮次，不作为正式发表时间
- **发表平台**：Under review as a conference paper at ICLR 2025；不能据此视为已录用；具体日期不详
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、AI方法与评测
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：ICLR 2025 Workshop：Quantify Uncertainty and Hallucination in Foundation Models: The Next Frontier in Reliable AI（首页）
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：XR与人机协作、AI方法与评测
...
- **时间与版本**：本地版本：2026-04-14（arXiv:2604.11201v2）；正式发表时间如已核实，见下一项。
- **发表平台**：Preprint, Under review；arXiv:2604.11201v2
- **论文与正式记录**：[arXiv本地版本 2604.11201v2](https://arxiv.org/abs/2604.11201v2)
...
- **时间与版本**：2026-03-14正式上线（AAAI期刊式论文集记录）
- **发表平台**：AAAI 2026，40(33):28131–28139；正式上线2026-03-14，DOI 10.1609/aaai.v40i33.40039（AAAI官方核验）。 [AAAI官方论文页](https://ojs.aaai.org/index.php/AAAI/article/view/40039)
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1609/aaai.v40i33.40039)
...
- **时间与版本**：本地版本：2026-03-01（arXiv:2509.23365v3）；正式发表时间如已核实，见下一项。
- **发表平台**：ICLR 2026（PDF首页）；arXiv:2509.23365v3
- **论文与正式记录**：[arXiv本地版本 2509.23365v3](https://arxiv.org/abs/2509.23365v3)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、AI方法与评测
...
- **时间与版本**：本地版本：2025-02-12（arXiv:2502.08524v1）；正式发表时间如已核实，见下一项。
- **发表平台**：ICLR 2026（官方会议论文列表核验）；本地为2025-02-13稿面日期的早期预印版，arXiv v1为2025-02-12。 [ICLR官方记录](https://iclr.cc/virtual/2026/papers.html)；[OpenReview稿件](https://openreview.net/pdf?id=P7RwEIiCyh)
- **论文与正式记录**：[arXiv本地版本 2502.08524v1](https://arxiv.org/abs/2502.08524v1)
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：NeurIPS 2025 Datasets and Benchmarks Track（论文版）
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
...
- **时间与版本**：本地版本：2024-12-05（arXiv:2405.18711v2）；正式发表时间如已核实，见下一项。
- **发表平台**：NeurIPS 2024 Main Conference Track（官方论文集核验）；本地arXiv v2为2024-12-05。 [NeurIPS官方论文集](https://proceedings.neurips.cc/paper_files/paper/2024/hash/d037fd021c9aace128b8ce25001cdb6c-Abstract-Conference.html)
- **论文与正式记录**：[arXiv本地版本 2405.18711v2](https://arxiv.org/abs/2405.18711v2)
...
- **时间与版本**：本地版本：2025-04-07（arXiv:2504.05419v1）；正式发表时间如已核实，见下一项。
- **发表平台**：COLM 2025正式论文已核实；本地仍为2025-04-07的arXiv v1，首页Preprint, Under review反映当时状态。以下实验数字按本地稿保留。[COLM正式论文](https://openreview.net/forum?id=O6I0Av7683)
- **论文与正式记录**：[arXiv本地版本 2504.05419v1](https://arxiv.org/abs/2504.05419v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：XR与人机协作、AI方法与评测
...
- **时间与版本**：本地版本：2018-04-10（arXiv:1804.03608v1）；正式发表时间如已核实，见下一项。
- **发表平台**：ECCV 2018，pp.598–613（官方ECVA核验）；文件名中的cvpr有误。 [ECVA官方论文页](https://www.ecva.net/papers/eccv_2018/papers_ECCV/html/Tanmay_Gupta_Imagine_This_Scripts_ECCV_2018_paper.php)
- **论文与正式记录**：[arXiv本地版本 1804.03608v1](https://arxiv.org/abs/1804.03608v1)
...
- **时间与版本**：本地版本：2018-05-09（arXiv:1803.10122v4）；正式发表时间如已核实，见下一项。
- **发表平台**：2018年World Models研究稿及互动论文网站；不与后续改题版本混合
- **论文与正式记录**：[arXiv本地版本 1803.10122v4](https://arxiv.org/abs/1803.10122v4)
...
- **时间与版本**：本地版本：2024-02-23（arXiv:2402.15391v1）；正式发表时间如已核实，见下一项。
- **发表平台**：本地Google DeepMind稿首页2024-02-26；页边arXiv:2402.15391v1标2024-02-23，区分稿面日期与版本时间
- **论文与正式记录**：[arXiv本地版本 2402.15391v1](https://arxiv.org/abs/2402.15391v1)
...
- **时间与版本**：本地版本：2024-05-24（arXiv:2405.15223v1）；正式发表时间如已核实，见下一项。
- **发表平台**：NeurIPS 2024 Main Conference Track（官方论文集核验）。 [NeurIPS官方论文集](https://proceedings.neurips.cc/paper_files/paper/2024/hash/7dbb5bfab324e3b86af9bd0df15498dd-Abstract-Conference.html)
- **论文与正式记录**：[arXiv本地版本 2405.15223v1](https://arxiv.org/abs/2405.15223v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：本地版本：2025-08-05（arXiv:2506.14404v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2506.14404v2（本地版本）
- **论文与正式记录**：[arXiv本地版本 2506.14404v2](https://arxiv.org/abs/2506.14404v2)
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：ACM Computing Surveys 57(10), Article268；2025-05-07上线，2025-10卷期；2025-04-01接受；DOI10.1145/3728459
- **论文与正式记录**：[DOI正式记录](https://doi.org/10.1145/3728459)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：创作与规则补全
...
- **时间与版本**：本地版本：2025-11-25（arXiv:2407.16655v3）；正式发表时间如已核实，见下一项。
- **发表平台**：ICLR 2025（PDF首页）；arXiv:2407.16655v3
- **论文与正式记录**：[arXiv本地版本 2407.16655v3](https://arxiv.org/abs/2407.16655v3)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **版本关系**：同一论文只保留本地2025-11-25 arXiv v3。P134的ICLR 2025会议文件已归档；作者顺序相同，v3首页3位共同一作，旧文件2位标星。旧条目链接跳转到本条。
- **主题**：创作与规则补全、世界机制与演化
...
- **时间与版本**：本地版本：2025-12-22（arXiv:2512.19539v1）；正式发表时间如已核实，见下一项。
- **发表平台**：首页2025-12-23；arXiv:2512.19539v1
- **论文与正式记录**：[arXiv本地版本 2512.19539v1](https://arxiv.org/abs/2512.19539v1)
...
- **时间与版本**：本地版本：2025-08-30（arXiv:2505.10292v2）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2505.10292v2（本地版本）
- **论文与正式记录**：[arXiv本地版本 2505.10292v2](https://arxiv.org/abs/2505.10292v2)
...
- **时间与版本**：本地版本：2026-01-08（arXiv:2601.04778v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2601.04778v1（本地版本）；代码/模型在稿中为待公开承诺
- **论文与正式记录**：[arXiv本地版本 2601.04778v1](https://arxiv.org/abs/2601.04778v1)
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化、AI方法与评测
...
- **时间与版本**：本地版本：2026-01-19（arXiv:2507.16869v3）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2507.16869v3（本地版本）；检索方法主要覆盖2020–2025，文件名26不等于内容只属2026
- **论文与正式记录**：[arXiv本地版本 2507.16869v3](https://arxiv.org/abs/2507.16869v3)
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：ICLR 2025（PDF首页）；文件名77无可靠年份含义
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **主题**：世界机制与演化
...
- **时间与版本**：本地版本：2025-12-08（arXiv:2512.07802v1）；正式发表时间如已核实，见下一项。
- **发表平台**：arXiv:2512.07802v1（本地版本）
- **论文与正式记录**：[arXiv本地版本 2512.07802v1](https://arxiv.org/abs/2512.07802v1)
...
- **时间与版本**：2025-04-16首发预印本；2025年NeurIPS发表；本地版本日期未明示
- **发表平台**：NeurIPS 2025 Main Conference Track（官方论文集核验）；arXiv:2504.12369首发2025-04-16；本地文件未明确具体版本日。 [NeurIPS官方论文集](https://papers.neurips.cc/paper_files/paper/2025/hash/470629a47e2d65ce0606c40055df5d26-Abstract-Conference.html)；[arXiv记录](https://arxiv.org/abs/2504.12369)
- **论文与正式记录**：[arXiv论文记录](https://arxiv.org/abs/2504.12369)
...
- **时间与版本**：2023年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：NeurIPS 2023 Datasets and Benchmarks Track（PDF首页）
...
- **时间与版本**：2025年；具体日期、卷期及稿件状态见下一项。本地独立修订日期未明确。
- **发表平台**：ICCV 2025，正文页码8733起（PDF论文版）
- **项目 · 代码 · 数据**：本地PDF未检出明确属于本文的项目链接；不代表作者没有发布资源。
- **版本关系**：同一论文只保留本地ICCV 2025正式论文版本。P102为2025-05-26 arXiv v1，已归档；该预印本的附录与提取全文仍在本地归档保留。旧条目链接跳转到本条。
- **主题**：创作与规则补全、世界机制与演化、XR与人机协作
...
- **时间与版本**：初稿2020；本地arXiv:2010.09890v2，2021-05-03。
- **发表平台**：ICLR 2021；本地PDF首页明确标注正式会议。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2010.09890v2)
...
- **时间与版本**：初稿2021；本地arXiv:2102.02926v3，2021-10-20。
- **发表平台**：NeurIPS 2021 Datasets and Benchmarks Track；本地首页有会议标注。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2102.02926v3)
...
- **时间与版本**：初稿2022；本地arXiv:2206.09203v2，2023-10-29。文件名的22对应初稿，不是正式会议年。
- **发表平台**：NeurIPS 2023 Datasets and Benchmarks Track；本地首页明确标注。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2206.09203v2)
...
- **时间与版本**：本地arXiv:2302.09664v3，2023-04-15。
- **发表平台**：ICLR 2023；本地首页明确标注。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2302.09664v3)
...
- **时间与版本**：本地arXiv:2312.03664v2，2023-12-13；封面标注December 2023。
- **发表平台**：Google DeepMind/Google Research技术报告、arXiv预印本；本地版本未标明正式会议或期刊。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2312.03664v2)
...
- **时间与版本**：初稿2024；本地arXiv:2408.00672v3，2025-04-11。
- **发表平台**：CVPR 2025；以CVF正式论文入口核实。
- **论文与正式记录**：[论文/发表记录 1](https://openaccess.thecvf.com/content/CVPR2025/papers/Ashutosh_ExpertAF_Expert_Actionable_Feedback_from_Video_CVPR_2025_paper.pdf) · [论文/发表记录 2](https://arxiv.org/abs/2408.00672v3)
...
- **时间与版本**：初稿2024；正式会议2025-04；本地arXiv:2410.01791v2，2025-11-22。文件名24_CHI不能用作正式发表年份。
- **发表平台**：CHI 2025，获Best Paper Award（微软作者机构记录）。本地30页arXiv版本仍含占位DOI/ISBN，不把这些占位符当成正式标识。
- **论文与正式记录**：[论文/发表记录 1](https://www.microsoft.com/en-us/research/publication/dreamgarden-a-designer-assistant-for-growing-games-from-a-single-prompt/?lang=ko-kr) · [论文/发表记录 2](https://arxiv.org/abs/2410.01791v2)
...
- **时间与版本**：2024-06-19在线发表；Nature卷期日期2024-06-20；本地为期刊排版版本。
- **发表平台**：Nature 630, 625–630 (2024)，DOI:10.1038/s41586-024-07421-0。
- **论文与正式记录**：[论文/发表记录 1](https://doi.org/10.1038/s41586-024-07421-0)
...
- **时间与版本**：初稿2024-05-31；本地arXiv:2406.00222v2，2025-07-27。
- **发表平台**：ICLR 2025；OpenReview正式会议版本及Google Research记录核实。
- **论文与正式记录**：[论文/发表记录 1](https://openreview.net/forum?id=SIE6VFps9x) · [论文/发表记录 2](https://research.google/pubs/learning-to-clarify-multi-turn-conversations-with-action-based-contrastive-self-training/) · [论文/发表记录 3](https://arxiv.org/abs/2406.00222v2)
...
- **时间与版本**：初稿2024-02；本地arXiv:2402.12275v3，2024-09-20。
- **发表平台**：NeurIPS 2024 Main Conference Track；正式proceedings核实。
- **论文与正式记录**：[论文/发表记录 1](https://proceedings.neurips.cc/paper_files/paper/2024/hash/820c61a0cd419163ccbd2c33b268816e-Abstract-Conference.html) · [论文/发表记录 2](https://arxiv.org/abs/2402.12275v3)
...
- **时间与版本**：初稿2024；本地arXiv:2404.10775v3，2025-04-16。文件名24_iclr与正式会议年不一致。
- **发表平台**：ICLR 2025；本地PDF首页明确标注。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2404.10775v3)
...
- **时间与版本**：初稿2024-06；本地arXiv:2406.06769v2，2024-10-07。
- **发表平台**：NeurIPS 2024 Datasets and Benchmarks Track；正式proceedings核实。
- **论文与正式记录**：[论文/发表记录 1](https://proceedings.neurips.cc/paper_files/paper/2024/hash/13836f251823945316ae067350a5c366-Abstract-Datasets_and_Benchmarks_Track.html) · [论文/发表记录 2](https://arxiv.org/abs/2406.06769v2)
...
- **时间与版本**：初稿2024-07-19；本地arXiv:2407.14507v3，2024-09-18。
- **发表平台**：arXiv综述预印本；尚未核实正式发表平台。页眉的JOURNAL OF LATEX CLASS FILES及AUGUST 2021为模板，不能作为期刊和发表日期。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2407.14507v3)
...
- **时间与版本**：2025-07，Findings of ACL 2025；本地为正式论文集版本，pp.26043–26066。
- **发表平台**：Findings of the Association for Computational Linguistics: ACL 2025；DOI:10.18653/v1/2025.findings-acl.1337。
- **论文与正式记录**：[论文/发表记录 1](https://aclanthology.org/2025.findings-acl.1337/)
...
- **时间与版本**：初稿2024-12-05；本地arXiv:2412.04447v2，2025-04-11；正式期刊在线发表2026-04-08。
- **发表平台**：International Journal of Computer Vision 134, article 222 (2026)，DOI:10.1007/s11263-026-02826-y。正式论文扩展为25个模型；以下摘要及数字仍按本地v2的21个模型记录。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2412.04447v2) · [论文/发表记录 2](https://link.springer.com/article/10.1007/s11263-026-02826-y)
...
- **时间与版本**：初稿2025-05；本地arXiv:2505.10819v4，2025-11-19；正式会议NeurIPS 2025。
- **发表平台**：Advances in Neural Information Processing Systems 38（NeurIPS 2025，主会）。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2505.10819v4) · [论文/发表记录 2](https://proceedings.neurips.cc/paper_files/paper/2025/hash/262dd62fd1bbb30d6a6b4d578f5e65ff-Abstract-Conference.html)
...
- **时间与版本**：初稿2024-12-09；本地arXiv:2412.06438v2，2025-10-07。
- **发表平台**：Google DeepMind研究预印本；尚未核实正式会议/期刊。arXiv页面亦可用旧题名Can foundation models actively gather information in interactive environments to test hypotheses?检索；本条保留本地PDF题名。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2412.06438v2)
...
- **时间与版本**：本地arXiv:2512.02622v1，2025-12-02。
- **发表平台**：arXiv预印本；项目页亦采用预印本引用，尚未核实正式会议录用。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2512.02622v1)
...
- **时间与版本**：2026；本地标注Published as a conference paper at ICLR 2026，未检出独立的精确版本日期。
- **发表平台**：International Conference on Learning Representations（ICLR 2026），正式论文集已核实。
- **论文与正式记录**：[论文/发表记录 1](https://proceedings.iclr.cc/paper_files/paper/2026/hash/1f49b7fbd7c7afc52c1db0d4ed1a338d-Abstract-Conference.html)
...
- **时间与版本**：本地arXiv:2607.09403v1，2026-07-10。首页所写August 2026为未核实模板信息，不采用为正式发表日期。
- **发表平台**：arXiv预印本。PDF含JAIR期刊模板及占位DOI 10.1613/jair.1.xxxxx；未查到足以确认JAIR正式发表的记录，不能按已发表JAIR论文引用。
- **论文与正式记录**：[论文/发表记录 1](https://arxiv.org/abs/2607.09403v1)
- **项目 · 代码 · 数据**：本地PDF及本次核查未检出明确属于本文的项目/代码入口；不代表作者没有发布资源。
- **主题**：创作与规则补全、世界机制与演化
...
<a id="p161"></a>
## P161 · Learning Long-form Movie Prior via Large Language Models

- **作者**：Jinheng Xie; Jiajun Feng; Mike Zheng Shou
- **时间与版本**：2026；作者仓库于2026-08-23宣布TPAMI录用。本地PDF为2026年IEEE已接收作者稿，页眉注明尚未完成最终编辑；本地下载日期为2026-09-16。
- **发表平台**：IEEE Transactions on Pattern Analysis and Machine Intelligence（TPAMI），2026，已接收作者版本；DOI: 10.1109/TPAMI.2026.3729756。当前PDF不能当作已完成最终编辑的卷期排版版。
- **论文与正式记录**：[IEEE DOI（本地版本）](https://doi.org/10.1109/TPAMI.2026.3729756)；[作者发表列表](https://sierkinhane.github.io/)；[相关早期预印本（旧题名）](https://arxiv.org/abs/2404.15909v1)
- **项目 · 代码 · 数据**：[作者代码与数据仓库](https://github.com/showlab/Long-form-Video-Prior)。仓库提供Storyboard20K标注下载及预处理、可视化脚本；截至核查时，仓库首页未提供完整训练流程或模型权重。原始电影帧需按仓库说明先申请MPII-MD访问授权。
- **版本关系**：作者仓库关联的早期预印本为Learning Long-form Video Prior via Generative Pre-Training（arXiv:2404.15909v1，2024-04-24，11位作者）；本条依据所给8页TPAMI版本，题名及3位作者按本地PDF记录，不混用早期版本的作者表或实验设置。
- **主题**：创作与规则补全、AI方法与评测
- **PDF版本**：8页；SHA-256：`5a757c4328c5277e646eb67a770d5f4e10998a3aa4469c5e04d38d6573a202eb`
- **核查日期**：2026-09-16
- **全文提取**：已在本机建立逐页文本；问答优先读取提取文件。
...
<a id="p162"></a>
## P162 · Timestep Embedding Tells: It's Time to Cache for Video Diffusion Model

- **作者**：Feng Liu; Shiwei Zhang; Xiaofeng Wang; Yujie Wei; Haonan Qiu; Yuzhong Zhao; Yingya Zhang; Qixiang Ye; Fang Wan
- **时间与版本**：arXiv首版2024-11-28；本地v2为2025-03-18，11页。
- **发表平台**：CVPR 2025（作者arXiv记录注明录用）；这里的实验和页码依据本地arXiv v2，不混用后续代码库扩展的模型结果。
- **论文与正式记录**：[arXiv本地版本 2411.19108v2](https://arxiv.org/abs/2411.19108v2)
- **项目 · 代码 · 数据**：[TeaCache项目页](https://liewfeng.github.io/TeaCache/)
- **版本关系**：补录此前未收录的本地PDF；2026-09-17从逐页提取文本核对摘要、方法及Table 1。
- **主题**：AI方法与评测、创作与规则补全
- **PDF版本**：11页；SHA-256：`e297f8becb2879b4a3611fa5877532a7e2db314af7e208127d6754dfc2741212`
- **核查日期**：2026-09-17
- **全文提取**：已在本机建立逐页文本；问答优先读取提取文件。
...
<a id="p163"></a>
## P163 · Automating the Search for Artificial Life with Foundation Models

- **作者**：Akarsh Kumar; Chris Lu; Louis Kirsch; Yujin Tang; Kenneth O. Stanley; Phillip Isola; David Ha
- **时间与版本**：arXiv首版2024-12-23；本地v2为2025-05-16，30页、19幅图。
- **发表平台**：本地记录为arXiv:2412.17799v2预印本；本次未据文件名推断正式会议或期刊。
- **论文与正式记录**：[arXiv本地版本 2412.17799v2](https://arxiv.org/abs/2412.17799v2)
- **项目 · 代码 · 数据**：[ASAL项目页](https://asal.sakana.ai/)；[作者代码仓库](https://github.com/SakanaAI/asal)
- **版本关系**：补录此前未收录的本地PDF；2026-09-17核对正文和实验附录的全文提取文件。
- **主题**：世界机制与演化、创作与规则补全、AI方法与评测
- **PDF版本**：30页；SHA-256：`e5178f7c213c7b2b0b22b5fc550b5410a67e908df74cbb81b3e22db17046d549`
- **核查日期**：2026-09-17
- **全文提取**：已在本机建立逐页文本；问答优先读取提取文件。
...
<a id="p164"></a>
## P164 · Diffusion as Shader: 3D-aware Video Diffusion for Versatile Video Generation Control
...
- **时间与版本**：arXiv首版2025-01-07；本地v2为2025-01-09，12页。
- **发表平台**：本地记录为arXiv:2501.03847v2预印本；ACM样式排版不能单独作为正式发表证明。
- **论文与正式记录**：[arXiv本地版本 2501.03847v2](https://arxiv.org/abs/2501.03847v2)
- **项目 · 代码 · 数据**：[Diffusion as Shader项目页](https://igl-hkust.github.io/das/)
- **版本关系**：补录此前未收录的本地PDF；2026-09-17核对逐页全文、Tables 1–3及失败案例。
- **主题**：创作与规则补全、世界机制与演化、AI方法与评测
- **PDF版本**：12页；SHA-256：`3fe084c39a33c92f39ca27646baea338690ea65f2299ba600fd62458f5a4b71a`
- **核查日期**：2026-09-17
- **全文提取**：已在本机建立逐页文本；问答优先读取提取文件。
